...
class MonodepthOptions:
    def __init__(self):
        ...
        self.parser.add_argument("--data_path",
                                 ...
                                 default="/data/coding/cityscapes_416/")
        # D:\datasets\kitti_raw_data_192640"，"/data/coding/kitti_jpg/")
        self.parser.add_argument("--log_dir",
                                 type=str,
                                 help="log directory",
                                 default='/data/coding/log/')
        # D:/codes/ubuntu/manydepthformer/log，/data/coding/log/")
        # TRAINING options
        ...
        self.parser.add_argument("--frame_ids",
                                 ...
                                 default=[0, -1, 1])
        #decoder option
        self.parser.add_argument("--use_attention_decoder", type=bool,
