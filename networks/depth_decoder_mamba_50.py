...
class MaDepthDecoder(nn.Module):
    def __init__(self,  depths=[2, 2, 2, 2, 2], dims=[64, 256, 512, 1024, 2048],
        ...
        self.transfer = nn.ModuleList(
            [
                ...
                nn.Conv2d(base_dims * 16, hidden_dim * 16, 1, bias=False),
                nn.Conv2d(base_dims * 32, hidden_dim * 32, 1, bias=False),
            ]
        )
