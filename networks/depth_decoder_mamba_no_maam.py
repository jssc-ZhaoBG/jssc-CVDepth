...
class MaDepthDecoder(nn.Module):
    ...
    def forward(self, input_features, edges):
        ...
        x_downsample = [torch.permute(input_features[0], (0,2,3,1)),torch.permute(input_features[1], (0,2,3,1)),torch.permute(input_features[2], (0,2,3,1))
                        ,torch.permute(input_features[3], (0,2,3,1)),torch.permute(input_features[4], (0,2,3,1))]
