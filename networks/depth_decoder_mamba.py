...
if __name__ == "__main__":
    ...
    encoder = ResnetEncoder(num_layers=50, pretrained=True, num_input_images=1).to('cuda')
    ...
    #
    # encoder2 = ResnetEncoderMatching(50, True, input_height=192, input_width=640, adaptive_bins=True, min_depth_bin=0.1,
    #                                 max_depth_bin=20.0, depth_binning='linear', num_depth_bins=96)
    # current_image = torch.randn(1,3, 192,640)
    # lookup_images = torch.randn(1, 1,3, 192,640)
    # poses = torch.randn(1, 1,4,4)
    # K = torch.randn(1, 4,4)
    # invK = torch.randn(1, 4,4)
    # feats2 = encoder2(current_image,lookup_images,poses,K,invK,min_depth_bin=0.1, max_depth_bin=10.0)
    # out2 = model(feats2)
    # print(out2['disp', 0].size())