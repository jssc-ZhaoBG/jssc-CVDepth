...
def evaluate(opt):
    ...
    opt.load_weights_folder = '/data/coding/weights_16'
    opt.data_path = '/data/coding/kitti_jpg'
    opt.eval_mono = True
    ...
    if opt.ext_disp_to_eval is None:
        ...
        depth_decoder = networks.MaDepthDecoder()
        ...
        with torch.no_grad():
            for i, data in tqdm.tqdm(enumerate(dataloader)):
                ...
                if opt.eval_teacher:
                    ...
                    output = depth_decoder(output, edges)
